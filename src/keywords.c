...
struct kw_t pragmas[] = {
{ {"PROG*",		NULL},	P_PROG,			N_PROG },
{ {"FINPROG*",	NULL},	P_FINPROG,		N_FINPROG },
{ {"SEG*",		NULL},	P_SEG,			N_SEG },
{ {"FINSEG*",	NULL},	P_FINSEG,		N_FINSEG },
{ {"MACRO*",	NULL},	P_MACRO,		N_MACRO },
{ {"FINMACRO*",	NULL},	P_FINMACRO,		N_FINMACRO },
{ {"RES*",		NULL},	P_RES,			N_RES },
{ {"S*",		NULL},	P_S,			N_SETIC },
{ {"F*",		NULL},	P_F,			N_ERR },
{ {"ALL*",		NULL},	P_ALL,			N_ERR },
{ {"NAME*",		NULL},	P_NAME,			N_ERR },
{ {"BA*",		NULL},	P_BA,			N_ERR },
{ {"INT*",		NULL},	P_INT,			N_ERR },
{ {"OUT*",		NULL},	P_OUT,			N_ERR },
{ {"LAB*",		NULL},	P_LAB,			N_ERR },
{ {"NLAB*",		NULL},	P_NLAB,			N_ERR },
{ {"MEM*",		NULL},	P_MEM,			N_ERR },
{ {"OS*",		NULL},	P_OS,			N_ERR },
{ {"IFUNK*",	NULL},	P_IFUNK,		N_IFUNK },
{ {"IFUND*",	NULL},	P_IFUND,		N_IFUND },
{ {"IFDEF*",	NULL},	P_IFDEF,		N_IFDEF },
{ {"FI*",		NULL},	P_FI,			N_FI },
{ {"SS*",		NULL},	P_SS,			N_OVL },
{ {"HS*",		NULL},	P_HS,			N_ERR },
{ {"MAX*",		NULL},	P_MAX,			N_ERR },
{ {"LEN*",		NULL},	P_LEN,			N_ERR },
{ {"E*",		NULL},	P_E,			N_ERR },
{ {"FILE*",		NULL},	P_FILE,			N_ERR },
{ {"TEXT*",		NULL},	P_TEXT,			N_TEXT },
{ {NULL,		NULL},	0,				0 }
};
